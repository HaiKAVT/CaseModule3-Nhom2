                            ...
                            <form class="row contact_form" method="post" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control" id="fullname"
                                           name="id" value="${sanpham.id}"
                                           placeholder="">
                                </div>

                                <label>Tên sản phẩm</label>
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control" id="Phone number" name="name" value="${sanpham.ten}"
                                           placeholder="" pattern="[-+]?[0-9]">
                                </div>

                                <label>Giá sản phẩm</label>
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control" id="Egmail" name="gia" value="${sanpham.gia}"
                                           placeholder="">
                                </div>
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control" id="Address" name="idloaisp" value="${sanpham.idloai}"
                                           placeholder="">
                                </div>

                                <label>Hình ảnh sản phẩm</label>
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control" id="Birthday" name="img" value="${sanpham.img}"
                                           placeholder="">
                                </div>
