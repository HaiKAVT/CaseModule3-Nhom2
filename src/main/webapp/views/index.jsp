                    ...
                    <div class="main-menu d-none d-lg-block">
                        <nav>
                            <ul id="navigation">
                                ...
                                <li><a href="#">Account</a>
                                    <ul class="submenu">
                                        <li><a href="login.html">Log out</a></li></ul>
                                </li>
                                <li><a>Contact</a>
                                    <ul class="submenu">
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 d-none d-sm-block">
                            <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                                <img src="../../Users/iU%20LOVE/OneDrive/Desktop/Module3/CaseModule3-Nhom2/assets/img/hero/watch.png" alt="" class=" heartbeat">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-4 col-md-6 col-sm-6">
                    <div class="single-gallery mb-30">
                        <div class="gallery-img big-img"
                             style="background-image: url(../../Users/iU LOVE/OneDrive/Desktop/Module3/CaseModule3-Nhom2/assets/img/gallery/gallery1.png);"></div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="single-gallery mb-30">
                        <div class="gallery-img big-img"
                             style="background-image: url(../../Users/iU LOVE/OneDrive/Desktop/Module3/CaseModule3-Nhom2/assets/img/gallery/gallery2.png);"></div>
                    </div>
                </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-6 col-sm-6">
                            <div class="single-gallery mb-30">
                                <div class="gallery-img small-img"
                                     style="background-image: url(../../Users/iU LOVE/OneDrive/Desktop/Module3/CaseModule3-Nhom2/assets/img/gallery/gallery3.png);"></div>
                            </div>
                        </div>
                        <div class="col-xl-12 col-lg-12  col-md-6 col-sm-6">
                            <div class="single-gallery mb-30">
                                <div class="gallery-img small-img"
                                     style="background-image: url(../../Users/iU LOVE/OneDrive/Desktop/Module3/CaseModule3-Nhom2/assets/img/gallery/gallery4.png);"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div class="single-popular-items mb-50 text-center">
                        ...
                        <div class="popular-caption">
                            <h3><a href="thongtinthanhtoan.html">Thermo Ball Etip Gloves</a></h3>
                            <span>$ 45,743</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="video-wrap">
                            <div class="play-btn "><a class="popup-video"
                                                      href="https://www.youtube.com/watch?v=CkSAUNZO5YI"><i
        ...
        <div class="watch-area section-padding30">
            <div class="container">
                <div class="row align-items-center justify-content-between padding-130">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-10">
                        <div class="choice-watch-img mb-40">
                            <img src="../../Users/iU%20LOVE/OneDrive/Desktop/Module3/CaseModule3-Nhom2/assets/img/gallery/choce_watch1.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 col-md-6 col-sm-10">
                        <div class="choice-watch-img mb-40">
                            <img src="../../Users/iU%20LOVE/OneDrive/Desktop/Module3/CaseModule3-Nhom2/assets/img/gallery/choce_watch2.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-6">
                        <div class="watch-details mb-40">
