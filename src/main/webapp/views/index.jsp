            ...
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-10">
                    <div class="section-tittle mb-70 text-center">
                        ...
                        <p>Từ ngày ý thức được sự tồn tại của thời gian và phát minh ra đồng hồ để đo đếm thời gian. Những
                            cỗ máy đã dạy con người rất nhiều bài học. Chính vì thế, chúng ta càng
                            có nhiều chiêm nghiệm hơn về cuộc sống, về những điều liên qua đến khái niệm "Thời Gian".</p>
                    </div>
                </div>
            </div>
