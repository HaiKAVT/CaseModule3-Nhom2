                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            ...
                            <form class="row contact_form" action="/login?action=createUser" method="post" novalidate="novalidate">
                                ...
                                <label>Phone</label>
                                <div class="col-md-12 form-group p_star">
                                    <input type="number" class="form-control" id="sdt" name="sdt" value=""
                                           placeholder="" >
                                </div>
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <a class="lost_pass" href="/login">Do you have account ? Sign in</a>
                                </div>
                            </form>
                        </div>
                    </div>
